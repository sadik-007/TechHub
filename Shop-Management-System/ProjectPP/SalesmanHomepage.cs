...
namespace ProjectPP
{
    public partial class SalesmanHomepage : Form
    {
        ...
        // Parameterless constructor for Designer or default
        public SalesmanHomepage()
        {
            InitializeComponent();
            _salesmanName = "Salesman";
        }

        // Constructor with salesmanName
        ...
        // Optional empty event handlers for designer
        private void SalesmanHomepage_Load_1(object sender, EventArgs e) { }
        ...
        private void lblWelcomeUser_Click_1(object sender, EventArgs e)
        {
